...
export const ALL_PERMISSIONS = [
  ...
  { value: 'order:approve',     label: 'Aprovar',         group: 'Pedidos'      },
  { value: 'order:invoice',     label: 'Faturar',         group: 'Pedidos'      },
  ...
  { value: 'purchase:approve',  label: 'Aprovar',         group: 'Compras'      },
  { value: 'purchase:receive',  label: 'Receber',         group: 'Compras'      },
  { value: 'purchase:finalize', label: 'Finalizar',       group: 'Compras'      },
  { value: 'purchase:cancel',   label: 'Cancelar',        group: 'Compras'      },
